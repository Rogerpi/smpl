#ifndef sbpl_interface_sbpl_dualplanner_manager_h
#define sbpl_interface_sbpl_dualplanner_manager_h
...
class SBPLDualPlannerManager : public planning_interface::PlannerManager
{
public:
    ...
    SBPLDualPlannerManager();
    virtual ~SBPLDualPlannerManager();
    ...
    std::map<std::string, SBPLDualPlanningContextPtr> m_contexts;
...
MOVEIT_CLASS_FORWARD(SBPLDualPlannerManager);
